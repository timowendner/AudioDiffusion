...
class ARVDiffusion(Diffusion):
    ...
    def forward(self, x: Tensor, **kwargs) -> Tensor:
        ...
        sigmas = torch.rand((b, 1, self.num_splits),
...
class ARVSampler(Sampler):
    ...
    def sample_loop(
        ...
        for i in progress_bar:
            ...
            progress_bar.set_description(
                f"Sampling (noise={sigmas[i+1,0,0,0]:.2f})")
    ...
    def forward(
        ...
        **kwargs,
        ...
        start = self.sample_start(
            num_items=num_items, num_steps=num_steps, **kwargs)
    ...
    def forward(  # type: ignore
        ...
        **kwargs,
        ...
        for i in progress_bar:
            ...
            progress_bar.set_description(
                f"Inpainting (noise={sigmas[i+1,0]:.2f})")
